<div class="w-full md:w-[450px] flex items-center justify-center mx-auto my-auto">
    <div class="p-5 rounded-lg shadow-xl w-full border border-gray-300 bg-white">
        <h1 class="text-lg xl:text-xl font-semibold mb-6 text-center">LogIn</h1>
        ...
        <form wire:submit.prevent='login' class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('forgot-password') }}" wire:navigate
                    class="text-sm text-blue-500 hover:underline">Forgot Password?</a>
            </div>

            <button wire:loading.remove type="submit"
                class="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800">Login</button>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">Don't have an account? <a href="{{ route('signup') }}" wire:navigate
                    class="font-bold hover:underline">SignUp</a></p>
        </div>
    </div>
</div>
